...
При использовании API-бэкенда рекомендуется модель **gemini-3.1-flash-lite**: она демонстрирует высокое качество перевода и доступна в рамках бесплатного тарифа Google AI Studio с высоким лимитом запросов.
